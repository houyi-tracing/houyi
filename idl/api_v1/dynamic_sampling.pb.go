...
type DynamicPerOperationSampling_StrategyType int32

const (
	DynamicPerOperationSampling_CONST         DynamicPerOperationSampling_StrategyType = 0
	DynamicPerOperationSampling_PROBABILITY   DynamicPerOperationSampling_StrategyType = 1
	DynamicPerOperationSampling_RATE_LIMITING DynamicPerOperationSampling_StrategyType = 2
)

// Enum value maps for DynamicPerOperationSampling_StrategyType.
var (
	DynamicPerOperationSampling_StrategyType_name = map[int32]string{
		0: "CONST",
		1: "PROBABILITY",
		2: "RATE_LIMITING",
	}
	DynamicPerOperationSampling_StrategyType_value = map[string]int32{
		"CONST":         0,
		"PROBABILITY":   1,
		"RATE_LIMITING": 2,
	}
...
func (x DynamicPerOperationSampling_StrategyType) Enum() *DynamicPerOperationSampling_StrategyType {
	p := new(DynamicPerOperationSampling_StrategyType)
	*p = x
	return p
}

func (x DynamicPerOperationSampling_StrategyType) String() string {
	return protoimpl.X.EnumStringOf(x.Descriptor(), protoreflect.EnumNumber(x))
}

func (DynamicPerOperationSampling_StrategyType) Descriptor() protoreflect.EnumDescriptor {
	return file_dynamic_sampling_proto_enumTypes[0].Descriptor()
}

func (DynamicPerOperationSampling_StrategyType) Type() protoreflect.EnumType {
	return &file_dynamic_sampling_proto_enumTypes[0]
}

func (x DynamicPerOperationSampling_StrategyType) Number() protoreflect.EnumNumber {
	return protoreflect.EnumNumber(x)
}

// Deprecated: Use DynamicPerOperationSampling_StrategyType.Descriptor instead.
func (DynamicPerOperationSampling_StrategyType) EnumDescriptor() ([]byte, []int) {
	return file_dynamic_sampling_proto_rawDescGZIP(), []int{6, 0}
}

type StrategyResponse_StrategyType int32

const (
	StrategyResponse_CONST         StrategyResponse_StrategyType = 0
	StrategyResponse_PROBABILITY   StrategyResponse_StrategyType = 1
	StrategyResponse_RATE_LIMITING StrategyResponse_StrategyType = 2
	StrategyResponse_ADAPTIVE      StrategyResponse_StrategyType = 3
	StrategyResponse_DYNAMIC       StrategyResponse_StrategyType = 4
)

// Enum value maps for StrategyResponse_StrategyType.
var (
	StrategyResponse_StrategyType_name = map[int32]string{
		0: "CONST",
		1: "PROBABILITY",
		2: "RATE_LIMITING",
		3: "ADAPTIVE",
	...
	StrategyResponse_StrategyType_value = map[string]int32{
		"CONST":         0,
		"PROBABILITY":   1,
		"RATE_LIMITING": 2,
		"ADAPTIVE":      3,
...
func (x StrategyResponse_StrategyType) Enum() *StrategyResponse_StrategyType {
	p := new(StrategyResponse_StrategyType)
	*p = x
	return p
}

func (x StrategyResponse_StrategyType) String() string {
	return protoimpl.X.EnumStringOf(x.Descriptor(), protoreflect.EnumNumber(x))
}

func (StrategyResponse_StrategyType) Descriptor() protoreflect.EnumDescriptor {
	return file_dynamic_sampling_proto_enumTypes[1].Descriptor()
}

func (StrategyResponse_StrategyType) Type() protoreflect.EnumType {
	return &file_dynamic_sampling_proto_enumTypes[1]
}

func (x StrategyResponse_StrategyType) Number() protoreflect.EnumNumber {
	return protoreflect.EnumNumber(x)
}

// Deprecated: Use StrategyResponse_StrategyType.Descriptor instead.
func (StrategyResponse_StrategyType) EnumDescriptor() ([]byte, []int) {
	return file_dynamic_sampling_proto_rawDescGZIP(), []int{8, 0}
}
...
type StrategyRequest struct {
	...
	Operations []*StrategyRequest_Operation `protobuf:"bytes,2,rep,name=operations,proto3" json:"operations,omitempty"`
}
...
type DynamicPerOperationSampling struct {
	...
	Operation    string                                   `protobuf:"bytes,1,opt,name=operation,proto3" json:"operation,omitempty"`
	StrategyType DynamicPerOperationSampling_StrategyType `protobuf:"varint,2,opt,name=strategyType,proto3,enum=sampling.DynamicPerOperationSampling_StrategyType" json:"strategyType,omitempty"`
...
func (x *DynamicPerOperationSampling) GetStrategyType() DynamicPerOperationSampling_StrategyType {
	if x != nil {
		return x.StrategyType
	}
	return DynamicPerOperationSampling_CONST
}
...
type StrategyResponse struct {
	...
	StrategyType StrategyResponse_StrategyType `protobuf:"varint,1,opt,name=strategyType,proto3,enum=sampling.StrategyResponse_StrategyType" json:"strategyType,omitempty"`
	// Types that are assignable to Strategy:
...
func (x *StrategyResponse) GetStrategyType() StrategyResponse_StrategyType {
	if x != nil {
		return x.StrategyType
	}
	return StrategyResponse_CONST
}
...
var file_dynamic_sampling_proto_rawDesc = []byte{
	...
	,
	...
	,
	...
	,
...
var file_dynamic_sampling_proto_enumTypes = make([]protoimpl.EnumInfo, 2)
var file_dynamic_sampling_proto_msgTypes = make([]protoimpl.MessageInfo, 15)
var file_dynamic_sampling_proto_goTypes = []interface{}{
	(DynamicPerOperationSampling_StrategyType)(0), // 0: sampling.DynamicPerOperationSampling.StrategyType
	(StrategyResponse_StrategyType)(0),            // 1: sampling.StrategyResponse.StrategyType
	(*StrategyRequest)(nil),                       // 2: sampling.StrategyRequest
	(*ConstSampling)(nil),                         // 3: sampling.ConstSampling
	(*ProbabilitySampling)(nil),                   // 4: sampling.ProbabilitySampling
	(*RateLimitingSampling)(nil),                  // 5: sampling.RateLimitingSampling
	(*PerOperationSampling)(nil),                  // 6: sampling.PerOperationSampling
	(*AdaptiveSampling)(nil),                      // 7: sampling.AdaptiveSampling
	(*DynamicPerOperationSampling)(nil),           // 8: sampling.DynamicPerOperationSampling
	(*DynamicSampling)(nil),                       // 9: sampling.DynamicSampling
	(*StrategyResponse)(nil),                      // 10: sampling.StrategyResponse
	(*NullRely)(nil),                              // 11: sampling.NullRely
	(*GetTagsRequest)(nil),                        // 12: sampling.GetTagsRequest
	(*GetTagsRely)(nil),                           // 13: sampling.GetTagsRely
	(*UpdateTagsRequest)(nil),                     // 14: sampling.UpdateTagsRequest
	(*UpdateTagsReply)(nil),                       // 15: sampling.UpdateTagsReply
	(*StrategyRequest_Operation)(nil),             // 16: sampling.StrategyRequest.Operation
	(*EvaluatingTag)(nil),                         // 17: houyi.EvaluatingTag
	(*Operation)(nil),                             // 18: houyi.Operation
}
var file_dynamic_sampling_proto_depIdxs = []int32{
	16, // 0: sampling.StrategyRequest.operations:type_name -> sampling.StrategyRequest.Operation
	4,  // 1: sampling.PerOperationSampling.strategy:type_name -> sampling.ProbabilitySampling
	6,  // 2: sampling.AdaptiveSampling.strategies:type_name -> sampling.PerOperationSampling
	0,  // 3: sampling.DynamicPerOperationSampling.strategyType:type_name -> sampling.DynamicPerOperationSampling.StrategyType
	3,  // 4: sampling.DynamicPerOperationSampling.const:type_name -> sampling.ConstSampling
	4,  // 5: sampling.DynamicPerOperationSampling.probability:type_name -> sampling.ProbabilitySampling
	5,  // 6: sampling.DynamicPerOperationSampling.rateLimiting:type_name -> sampling.RateLimitingSampling
	8,  // 7: sampling.DynamicSampling.strategies:type_name -> sampling.DynamicPerOperationSampling
	1,  // 8: sampling.StrategyResponse.strategyType:type_name -> sampling.StrategyResponse.StrategyType
	3,  // 9: sampling.StrategyResponse.const:type_name -> sampling.ConstSampling
	4,  // 10: sampling.StrategyResponse.probability:type_name -> sampling.ProbabilitySampling
	5,  // 11: sampling.StrategyResponse.rateLimiting:type_name -> sampling.RateLimitingSampling
	7,  // 12: sampling.StrategyResponse.adaptive:type_name -> sampling.AdaptiveSampling
	9,  // 13: sampling.StrategyResponse.dynamic:type_name -> sampling.DynamicSampling
	17, // 14: sampling.GetTagsRely.tags:type_name -> houyi.EvaluatingTag
	17, // 15: sampling.UpdateTagsRequest.tags:type_name -> houyi.EvaluatingTag
	2,  // 16: sampling.StrategyManager.GetStrategy:input_type -> sampling.StrategyRequest
	18, // 17: sampling.DynamicStrategyManager.Promote:input_type -> houyi.Operation
	12, // 18: sampling.EvaluatorManager.GetTags:input_type -> sampling.GetTagsRequest
	14, // 19: sampling.EvaluatorManager.UpdateTags:input_type -> sampling.UpdateTagsRequest
	10, // 20: sampling.StrategyManager.GetStrategy:output_type -> sampling.StrategyResponse
	11, // 21: sampling.DynamicStrategyManager.Promote:output_type -> sampling.NullRely
	13, // 22: sampling.EvaluatorManager.GetTags:output_type -> sampling.GetTagsRely
	15, // 23: sampling.EvaluatorManager.UpdateTags:output_type -> sampling.UpdateTagsReply
