...
import (
	"fmt"
	"github.com/houyi-tracing/houyi/cmd/agent/app/httpserver"
...
func (b *Builder) CreateAgent(primaryProxy app.CollectorProxy, logger *zap.Logger, mFactory metrics.Factory) (*app.Agent, error) {
	...
	return app.NewAgent(processors, server, logger), nil
}

func (b *Builder) getReporter(primaryProxy app.CollectorProxy) reporter.Reporter {
